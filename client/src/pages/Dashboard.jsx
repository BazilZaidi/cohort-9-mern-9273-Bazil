...
//             </button>
//             {showSettings && (
//               <div className="absolute left-0 top-full mt-1 w-full bg-white border border-gray-200 rounded-lg shadow-lg z-20 p-2">
//                 <button
//                   type="button"
//                   onClick={() => {
//                     toggleTheme();
...
//                   }}
//                   className="w-full flex items-center justify-between gap-2 px-3 py-2 rounded-lg text-sm text-gray-700 hover:bg-gray-50 transition-colors"
//                 >
